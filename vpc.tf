...
resource "aws_subnet" "subnet_publica_1" {
  ...
  tags = {
    Name = "AUY1105-EV1-subnet-publica-1"
  }
}
...
resource "aws_subnet" "subnet_publica_2" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "AUY1105-EV1-subnet-publica-2"
  }
}
...
resource "aws_subnet" "subnet_privada_1" {
  ...
  availability_zone = "us-east-1a"
  tags = {
    Name = "AUY1105-EV1-subnet-privada-1"
  }
}
...
resource "aws_subnet" "subnet_privada_2" {
  ...
  availability_zone = "us-east-1b"
  tags = {
    Name = "AUY1105-EV1-subnet-privada-2"
  }
}
